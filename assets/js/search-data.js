...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "teaching",
          description: "Courses I have taught at Fordham and UNC.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-new-preprint-with-boyce-griffith-on-composite-b-spline-current-deposition-and-interpolation-operators-for-thin-wire-fdtd-simulations",
          title: 'New preprint with Boyce Griffith on composite B-spline current deposition and interpolation operators...',
          description: "",
          section: "News",},{id: "news-new-preprint-with-boyce-griffith-on-coupling-aware-vanka-smoothing-for-multigrid-preconditioning-of-implicit-immersed-boundary-equations",
          title: 'New preprint with Boyce Griffith on coupling-aware Vanka smoothing for multigrid preconditioning of...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=PdFSAtwAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
